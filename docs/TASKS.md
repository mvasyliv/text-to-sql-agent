...
| ID | Date | Title | Status | Summary | Related Files |
| --- | --- | --- | --- | --- | --- |
| T-2026-05-11-006 | 2026-05-11 | Show canonical venv in status bar | done | Updated VS Code Python settings so the interpreter label is always shown in the status bar, making `venvtext2sql` visible while working. | `.vscode/settings.json`, `docs/TASKS.md`, `docs/WORKLOG.md`, `docs/CHANGELOG.md` |
